...
@Service
public class FBWEnduranceWorkoutGenerator {

    private ExerciseGenerator exerciseGenerator;

    public FBWEnduranceWorkoutGenerator(ExerciseGenerator exerciseGenerator) {
        this.exerciseGenerator = exerciseGenerator;
    }

    public List<Exercise> generateExerciseList() {
        List<Exercise> exerciseList = new ArrayList<>();
        exerciseList.addAll(exerciseGenerator.generateUniqueRandomExercises(CHEST, 1));
        exerciseList.addAll(exerciseGenerator.generateUniqueRandomExercises(BACK, 1));
        exerciseList.addAll(exerciseGenerator.generateUniqueRandomExercises(LEGS, 1));
